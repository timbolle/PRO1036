...
::: {.column width="40%"}
[[tidyverse.org](https://www.tidyverse.org/)]{.light-red style="font-size: 1.5em;"}
...
[[rmarkdown.rstudio.com](https://rmarkdown.rstudio.com/)]{.light-red style="font-size: 1.5em;"}
...
::: {.column width="40%"}
![](figs/R-Markdown_logo.png){width="20%"}
:::
:::
